...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private EditText email, password, name, phonenum, gender, age, pincode;
...
//        actionBar.setDisplayHomeAsUpEnabled(true);
        ...
        gender = findViewById(R.id.entergender);
        ...
        mRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String genn = gender.getText().toString().trim();
                ...
                if (!Patterns.EMAIL_ADDRESS.matcher(emaill).matches()) {
                    ...
                    registerUser(emaill, pass, uname, phnum, genn, agee);
                }
            }
        });
    ...
    private void registerUser(String emaill, final String pass, final String uname, final String phnum, final String genn, final String agee) {
        progressDialog.show();
        mAuth.createUserWithEmailAndPassword(emaill, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    hashMap.put("gender",genn);
                    hashMap.put("age",agee);
